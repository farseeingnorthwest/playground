...
func ExampleBattleField_Run_special_3b() {
	...
	// signal=154 source.position=0 source.side=Left source.reactor="+5% Attack*" lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=0
	// signal=154 source.position=0 source.side=Left source.reactor="+5% Attack*" lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=1
	// signal=154 source.position=0 source.side=Left source.reactor="+5% Attack*" lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=2
	...
	// signal=214 source.position=0 source.side=Left source.reactor="+5% Attack*" lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=0
	// signal=214 source.position=0 source.side=Left source.reactor="+5% Attack*" lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=1
	// signal=214 source.position=0 source.side=Left source.reactor="+5% Attack*" lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=2
	// verb=buff/overflow reactor="+5% Attack*" target.side=Left target.position=0
	// stacking=3 verb=buff reactor="+5% Attack*" target.side=Left target.position=0 source.reactor="@PreAction({$} +5% Attack*)"
