...
func ExampleBattleField_Run_special_0() {
	...
	// signal=15 source.position=0 source.side=Left source.reactor="@Launch({*} 480% Damage; {1} 520% Damage)" lifecycle.leading=0 lifecycle.cooling="{Current:4 Maximum:4}" lifecycle.capacity=-1
	...
	// signal=69 source.position=0 source.side=Left source.reactor="@Launch({*} 480% Damage; {1} 520% Damage)" lifecycle.leading=0 lifecycle.cooling="{Current:3 Maximum:4}" lifecycle.capacity=-1
	// signal=80 source.position=0 source.side=Left source.reactor="@Launch({1} 3 * 460% Damage)" lifecycle.leading=0 lifecycle.cooling="{Current:5 Maximum:5}" lifecycle.capacity=-1
...
func ExampleBattleField_Run_special_1() {
	...
	// signal=45 source.position=0 source.side=Left source.reactor="@Launch({$} Barrier)" lifecycle.leading=0 lifecycle.cooling="{Current:3 Maximum:4}" lifecycle.capacity=-1
	// signal=45 source.position=0 source.side=Left source.reactor="@Launch({1} 520% Damage, P(70%, Stun))" lifecycle.leading=0 lifecycle.cooling="{Current:3 Maximum:4}" lifecycle.capacity=-1
	// signal=45 source.position=0 source.side=Right source.reactor=Stun lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=0
	// signal=62 source.position=0 source.side=Left source.reactor="@Launch({2} 420% Damage, +30% Loss, Sleep)" lifecycle.leading=0 lifecycle.cooling="{Current:5 Maximum:5}" lifecycle.capacity=-1
	...
	// signal=95 source.position=0 source.side=Left source.reactor="@Launch({$} Barrier)" lifecycle.leading=0 lifecycle.cooling="{Current:2 Maximum:4}" lifecycle.capacity=-1
	// signal=95 source.position=0 source.side=Left source.reactor="@Launch({1} 520% Damage, P(70%, Stun))" lifecycle.leading=0 lifecycle.cooling="{Current:2 Maximum:4}" lifecycle.capacity=-1
	// signal=95 source.position=0 source.side=Left source.reactor="@Launch({2} 420% Damage, +30% Loss, Sleep)" lifecycle.leading=0 lifecycle.cooling="{Current:4 Maximum:5}" lifecycle.capacity=-1
	// signal=95 source.position=0 source.side=Right source.reactor=Sleep lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=0
	// signal=95 source.position=0 source.side=Right source.reactor="+30% Loss" lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=0
	...
	// signal=133 source.position=0 source.side=Right source.reactor=#2 lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=0
	// verb=buff reactor="Nerf #2" target.side=Left target.position=0 source.reactor=#2
	// signal=145 source.position=0 source.side=Left source.reactor="@Launch({$} Barrier)" lifecycle.leading=0 lifecycle.cooling="{Current:1 Maximum:4}" lifecycle.capacity=-1
	// signal=145 source.position=0 source.side=Left source.reactor="@Launch({1} 520% Damage, P(70%, Stun))" lifecycle.leading=0 lifecycle.cooling="{Current:1 Maximum:4}" lifecycle.capacity=-1
	// signal=145 source.position=0 source.side=Left source.reactor="@Launch({2} 420% Damage, +30% Loss, Sleep)" lifecycle.leading=0 lifecycle.cooling="{Current:3 Maximum:5}" lifecycle.capacity=-1
	...
	// signal=177 source.position=0 source.side=Right source.reactor=#1 lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=0
	// verb=buff reactor="Nerf #1" target.side=Left target.position=0 source.reactor=#1
	// signal=184 source.position=0 source.side=Left source.reactor="@PostAction({$/<Nerf> >= 2} Purge())" lifecycle.leading=0 lifecycle.cooling="{Current:4 Maximum:4}" lifecycle.capacity=-1
	// verb=purge reactors="[Nerf #2 Nerf #1]"
	// signal=198 source.position=0 source.side=Left source.reactor="@Launch({$} Barrier)" lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:4}" lifecycle.capacity=-1
	// signal=198 source.position=0 source.side=Left source.reactor="@Launch({1} 520% Damage, P(70%, Stun))" lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:4}" lifecycle.capacity=-1
	// signal=198 source.position=0 source.side=Left source.reactor="@PostAction({$/<Nerf> >= 2} Purge())" lifecycle.leading=0 lifecycle.cooling="{Current:3 Maximum:4}" lifecycle.capacity=-1
	// signal=198 source.position=0 source.side=Left source.reactor="@Launch({2} 420% Damage, +30% Loss, Sleep)" lifecycle.leading=0 lifecycle.cooling="{Current:2 Maximum:5}" lifecycle.capacity=-1
	// signal=218 source.position=0 source.side=Left source.reactor="@Launch({$} Barrier)" lifecycle.leading=0 lifecycle.cooling="{Current:4 Maximum:4}" lifecycle.capacity=-1
	// signal=218 source.position=0 source.side=Left source.reactor="@Launch({1} 520% Damage, P(70%, Stun))" lifecycle.leading=0 lifecycle.cooling="{Current:4 Maximum:4}" lifecycle.capacity=-1
	// verb=buff reactor=Barrier target.side=Left target.position=0 source.reactor="@Launch({$} Barrier)"
...
func ExampleBattleField_Run_special_2() {
	...
	// signal=21 source.position=0 source.side=Left source.reactor="@Launch({1!/%} 400% Critical Damage)" lifecycle.leading=0 lifecycle.cooling="{Current:3 Maximum:3}" lifecycle.capacity=-1
	...
	// signal=58 source.position=0 source.side=Left source.reactor="@Launch({1!/%} 400% Critical Damage)" lifecycle.leading=0 lifecycle.cooling="{Current:2 Maximum:3}" lifecycle.capacity=-1
	// signal=69 source.position=0 source.side=Left source.reactor="@Launch({1^/%} 400% Critical Damage)" lifecycle.leading=0 lifecycle.cooling="{Current:3 Maximum:3}" lifecycle.capacity=-1
	...
	// signal=106 source.position=0 source.side=Left source.reactor="@Launch({1!/%} 400% Critical Damage)" lifecycle.leading=0 lifecycle.cooling="{Current:1 Maximum:3}" lifecycle.capacity=-1
	// signal=106 source.position=0 source.side=Left source.reactor="@Launch({1^/%} 400% Critical Damage)" lifecycle.leading=0 lifecycle.cooling="{Current:2 Maximum:3}" lifecycle.capacity=-1
...
func ExampleBattleField_Run_special_3() {
	...
	// signal=48 source.position=0 source.side=Left source.reactor="@Launch({3!/%} 250% Damage+)" lifecycle.leading=0 lifecycle.cooling="{Current:3 Maximum:4}" lifecycle.capacity=-1
	// signal=59 source.position=0 source.side=Left source.reactor="@Launch({1^/D} 4 * 340% Damage)" lifecycle.leading=0 lifecycle.cooling="{Current:4 Maximum:4}" lifecycle.capacity=-1
	...
	// signal=135 source.position=0 source.side=Left source.reactor="@Launch({3!/%} 250% Damage+)" lifecycle.leading=0 lifecycle.cooling="{Current:2 Maximum:4}" lifecycle.capacity=-1
	// signal=135 source.position=0 source.side=Left source.reactor="@Launch({1^/D} 4 * 340% Damage)" lifecycle.leading=0 lifecycle.cooling="{Current:3 Maximum:4}" lifecycle.capacity=-1
...
func ExampleBattleField_Run_special_3b() {
	...
	// signal=46 source.position=0 source.side=Left source.reactor="+5% Attack*" lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=2
	...
	// signal=94 source.position=0 source.side=Left source.reactor="+5% Attack*" lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=1
	// signal=94 source.position=0 source.side=Left source.reactor="+5% Attack*" lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=2
	...
	// signal=148 source.position=0 source.side=Left source.reactor="+5% Attack*" lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=0
	// signal=148 source.position=0 source.side=Left source.reactor="+5% Attack*" lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=1
	// signal=148 source.position=0 source.side=Left source.reactor="+5% Attack*" lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=2
	// verb=buff/overflow reactor="+5% Attack*" target.side=Left target.position=0
	// stacking=3 verb=buff reactor="+5% Attack*" target.side=Left target.position=0 source.reactor="@PreAction({$} +5% Attack*)"
	...
	// signal=205 source.position=0 source.side=Left source.reactor="+5% Attack*" lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=0
	// signal=205 source.position=0 source.side=Left source.reactor="+5% Attack*" lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=1
	// signal=205 source.position=0 source.side=Left source.reactor="+5% Attack*" lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=2
	// verb=buff/overflow reactor="+5% Attack*" target.side=Left target.position=0
	// stacking=3 verb=buff reactor="+5% Attack*" target.side=Left target.position=0 source.reactor="@PreAction({$} +5% Attack*)"
...
func ExampleBattleField_Run_special_4() {
	...
	// signal=64 source.position=0 source.side=Left source.reactor="@Launch({$/>= 60%}, -15% Damage, Taunt)" lifecycle.leading=0 lifecycle.cooling="{Current:3 Maximum:4}" lifecycle.capacity=-1
	// signal=64 source.position=0 source.side=Left source.reactor="@Launch({1} 560% Damage, -25% Damage)" lifecycle.leading=0 lifecycle.cooling="{Current:3 Maximum:4}" lifecycle.capacity=-1
	// signal=64 source.position=0 source.side=Left source.reactor=Taunt lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=1
	// signal=64 source.position=0 source.side=Left source.reactor="-15% Damage" lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=1
	// signal=64 source.position=0 source.side=Right source.reactor="-25% Damage" lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=1
	// signal=87 source.position=0 source.side=Left source.reactor="@Launch({*} 300% Damage)" lifecycle.leading=0 lifecycle.cooling="{Current:5 Maximum:5}" lifecycle.capacity=-1
	...
	// signal=121 source.position=0 source.side=Left source.reactor="@Launch({$/>= 60%}, -15% Damage, Taunt)" lifecycle.leading=0 lifecycle.cooling="{Current:2 Maximum:4}" lifecycle.capacity=-1
	// signal=121 source.position=0 source.side=Left source.reactor="@Launch({1} 560% Damage, -25% Damage)" lifecycle.leading=0 lifecycle.cooling="{Current:2 Maximum:4}" lifecycle.capacity=-1
	// signal=121 source.position=0 source.side=Left source.reactor="@Launch({*} 300% Damage)" lifecycle.leading=0 lifecycle.cooling="{Current:4 Maximum:5}" lifecycle.capacity=-1
	// signal=121 source.position=0 source.side=Left source.reactor=Taunt lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=0
	// signal=121 source.position=0 source.side=Left source.reactor="-15% Damage" lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=0
	// signal=121 source.position=0 source.side=Right source.reactor="-25% Damage" lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=0
...
func ExampleBattleField_Run_special_5() {
	...
	// signal=16 source.position=0 source.side=Left source.reactor="@Launch({3} 510% Damage)" lifecycle.leading=0 lifecycle.cooling="{Current:4 Maximum:4}" lifecycle.capacity=-1
	...
	// signal=58 source.position=0 source.side=Left source.reactor="@Launch({3} 510% Damage)" lifecycle.leading=0 lifecycle.cooling="{Current:3 Maximum:4}" lifecycle.capacity=-1
	// signal=69 source.position=0 source.side=Left source.reactor="@Launch({1} 3 * 550% Damage, P(50%) Stun)" lifecycle.leading=0 lifecycle.cooling="{Current:4 Maximum:4}" lifecycle.capacity=-1
	...
	// signal=122 source.position=0 source.side=Left source.reactor="@Launch({3} 510% Damage)" lifecycle.leading=0 lifecycle.cooling="{Current:2 Maximum:4}" lifecycle.capacity=-1
	// signal=122 source.position=0 source.side=Left source.reactor="@Launch({1} 3 * 550% Damage, P(50%) Stun)" lifecycle.leading=0 lifecycle.cooling="{Current:3 Maximum:4}" lifecycle.capacity=-1
	// signal=122 source.position=0 source.side=Right source.reactor=Stun lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=0
	...
	// signal=171 source.position=0 source.side=Left source.reactor="@Launch({3} 510% Damage)" lifecycle.leading=0 lifecycle.cooling="{Current:1 Maximum:4}" lifecycle.capacity=-1
	// signal=171 source.position=0 source.side=Left source.reactor="@Launch({1} 3 * 550% Damage, P(50%) Stun)" lifecycle.leading=0 lifecycle.cooling="{Current:2 Maximum:4}" lifecycle.capacity=-1
...
func ExampleBattleField_Run_special_6() {
	...
	// signal=15 source.position=0 source.side=Left source.reactor="@Launch({1} 4 * 350% Damage; {*} +40% Shield)" lifecycle.leading=0 lifecycle.cooling="{Current:4 Maximum:4}" lifecycle.capacity=-1
	...
	// signal=83 source.position=0 source.side=Left source.reactor=Shield lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=29
	...
	// signal=99 source.position=0 source.side=Left source.reactor="@Launch({1} 4 * 350% Damage; {*} +40% Shield)" lifecycle.leading=0 lifecycle.cooling="{Current:3 Maximum:4}" lifecycle.capacity=-1
	// signal=99 source.position=0 source.side=Right source.reactor="-15% Damage" lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=0
	// signal=113 source.position=0 source.side=Left source.reactor="@Launch({~}, 15% Damage*)" lifecycle.leading=0 lifecycle.cooling="{Current:4 Maximum:4}" lifecycle.capacity=-1
	// verb=buff reactor="15% Damage*" target.side=Left target.position=0 source.reactor="@Launch({~}, 15% Damage*)"
	// signal=136 source.position=0 source.side=Left source.reactor=Shield lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=0
	...
	// signal=146 source.position=0 source.side=Left source.reactor="@Launch({1} 4 * 350% Damage; {*} +40% Shield)" lifecycle.leading=0 lifecycle.cooling="{Current:2 Maximum:4}" lifecycle.capacity=-1
	// signal=146 source.position=0 source.side=Left source.reactor="@Launch({~}, 15% Damage*)" lifecycle.leading=0 lifecycle.cooling="{Current:3 Maximum:4}" lifecycle.capacity=-1
	// signal=146 source.position=0 source.side=Left source.reactor="15% Damage*" lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=1
	...
	// signal=194 source.position=0 source.side=Left source.reactor="@Launch({1} 4 * 350% Damage; {*} +40% Shield)" lifecycle.leading=0 lifecycle.cooling="{Current:1 Maximum:4}" lifecycle.capacity=-1
	// signal=194 source.position=0 source.side=Left source.reactor="@Launch({~}, 15% Damage*)" lifecycle.leading=0 lifecycle.cooling="{Current:2 Maximum:4}" lifecycle.capacity=-1
	// signal=194 source.position=0 source.side=Left source.reactor="15% Damage*" lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=0
...
func ExampleBattleField_Run_special_7() {
	...
	// signal=33 source.position=0 source.side=Right source.reactor=#3 lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=0
	...
	// signal=57 source.position=0 source.side=Left source.reactor="@Launch({1} 455% Damage, BuffImmune" lifecycle.leading=0 lifecycle.cooling="{Current:2 Maximum:3}" lifecycle.capacity=-1
	// signal=57 source.position=0 source.side=Right source.reactor=BuffImmune lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=2
	// signal=71 source.position=0 source.side=Left source.reactor="@Launch({1} 2 * 360% Damage, 15% Stun)" lifecycle.leading=0 lifecycle.cooling="{Current:4 Maximum:4}" lifecycle.capacity=-1
	...
	// signal=109 source.position=0 source.side=Left source.reactor="@Launch({1} 455% Damage, BuffImmune" lifecycle.leading=0 lifecycle.cooling="{Current:1 Maximum:3}" lifecycle.capacity=-1
	// signal=109 source.position=0 source.side=Left source.reactor="@Launch({1} 2 * 360% Damage, 15% Stun)" lifecycle.leading=0 lifecycle.cooling="{Current:3 Maximum:4}" lifecycle.capacity=-1
	// signal=109 source.position=0 source.side=Right source.reactor=Stun lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=0
	// signal=109 source.position=0 source.side=Right source.reactor=BuffImmune lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=1
	...
	// signal=159 source.position=0 source.side=Left source.reactor="@Launch({1} 455% Damage, BuffImmune" lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:3}" lifecycle.capacity=-1
	// signal=159 source.position=0 source.side=Left source.reactor="@Launch({1} 2 * 360% Damage, 15% Stun)" lifecycle.leading=0 lifecycle.cooling="{Current:2 Maximum:4}" lifecycle.capacity=-1
	// signal=159 source.position=0 source.side=Right source.reactor=BuffImmune lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=0
	// signal=176 source.position=0 source.side=Left source.reactor="@Launch({1} 455% Damage, BuffImmune" lifecycle.leading=0 lifecycle.cooling="{Current:3 Maximum:3}" lifecycle.capacity=-1
...
func ExampleBattleField_Run_special_8() {
	...
	// signal=15 source.position=0 source.side=Left source.reactor="@Launch({$} ControlImmune)" lifecycle.leading=0 lifecycle.cooling="{Current:5 Maximum:5}" lifecycle.capacity=-1
	// signal=15 source.position=0 source.side=Left source.reactor="@Launch({1!/%} 340% Damage, {~1!/%} 80% Damage+)" lifecycle.leading=0 lifecycle.cooling="{Current:4 Maximum:4}" lifecycle.capacity=-1
	...
	// signal=50 source.position=0 source.side=Right source.reactor=#1 lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=0
	// immune.side=Left immune.position=0
	// targets=1 falseTargets=0 immuneTargets=1
	// signal=62 source.position=0 source.side=Left source.reactor="@Launch({$} ControlImmune)" lifecycle.leading=0 lifecycle.cooling="{Current:4 Maximum:5}" lifecycle.capacity=-1
	// signal=62 source.position=0 source.side=Left source.reactor="@Launch({1!/%} 340% Damage, {~1!/%} 80% Damage+)" lifecycle.leading=0 lifecycle.cooling="{Current:3 Maximum:4}" lifecycle.capacity=-1
	// signal=62 source.position=0 source.side=Left source.reactor=ControlImmune lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=1
	// signal=79 source.position=0 source.side=Left source.reactor="@Launch({*} +120% Shield, 7% Regeneration)" lifecycle.leading=0 lifecycle.cooling="{Current:4 Maximum:4}" lifecycle.capacity=-1
	...
	// signal=107 source.position=0 source.side=Left source.reactor=Shield lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=0
	...
	// signal=117 source.position=0 source.side=Left source.reactor="@Launch({$} ControlImmune)" lifecycle.leading=0 lifecycle.cooling="{Current:3 Maximum:5}" lifecycle.capacity=-1
	// signal=117 source.position=0 source.side=Left source.reactor="@Launch({1!/%} 340% Damage, {~1!/%} 80% Damage+)" lifecycle.leading=0 lifecycle.cooling="{Current:2 Maximum:4}" lifecycle.capacity=-1
	// signal=117 source.position=0 source.side=Left source.reactor="@Launch({*} +120% Shield, 7% Regeneration)" lifecycle.leading=0 lifecycle.cooling="{Current:3 Maximum:4}" lifecycle.capacity=-1
	// signal=117 source.position=0 source.side=Left source.reactor=ControlImmune lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=0
	// signal=132 source.position=0 source.side=Left source.reactor=Regeneration lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=0
	...
	// signal=178 source.position=0 source.side=Left source.reactor="@Launch({$} ControlImmune)" lifecycle.leading=0 lifecycle.cooling="{Current:2 Maximum:5}" lifecycle.capacity=-1
	// signal=178 source.position=0 source.side=Left source.reactor="@Launch({1!/%} 340% Damage, {~1!/%} 80% Damage+)" lifecycle.leading=0 lifecycle.cooling="{Current:1 Maximum:4}" lifecycle.capacity=-1
	// signal=178 source.position=0 source.side=Left source.reactor="@Launch({*} +120% Shield, 7% Regeneration)" lifecycle.leading=0 lifecycle.cooling="{Current:2 Maximum:4}" lifecycle.capacity=-1
...
func ExampleBattleField_Run_special_9() {
	...
	// signal=52 source.position=0 source.side=Right source.reactor=#2 lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=0
	// verb=buff reactor="Nerf #2" target.side=Left target.position=0 source.reactor=#2
	// signal=64 source.position=0 source.side=Left source.reactor="@Launch({1!/%} 3 * 380% Damage)" lifecycle.leading=0 lifecycle.cooling="{Current:3 Maximum:4}" lifecycle.capacity=-1
	// signal=75 source.position=0 source.side=Left source.reactor="@Launch[..4]({$} Remove 2 Nerf)" lifecycle.leading=2 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=-1
	// signal=75 source.position=0 source.side=Left source.reactor="@Launch({1} 3 * 350% Damage, -50% Defense)" lifecycle.leading=0 lifecycle.cooling="{Current:4 Maximum:4}" lifecycle.capacity=-1
	...
	// signal=124 source.position=0 source.side=Right source.reactor=#1 lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=0
	// verb=buff reactor="Nerf #1" target.side=Left target.position=0 source.reactor=#1
	// signal=136 source.position=0 source.side=Left source.reactor="@Launch({1!/%} 3 * 380% Damage)" lifecycle.leading=0 lifecycle.cooling="{Current:2 Maximum:4}" lifecycle.capacity=-1
	// signal=136 source.position=0 source.side=Left source.reactor="@Launch({1} 3 * 350% Damage, -50% Defense)" lifecycle.leading=0 lifecycle.cooling="{Current:3 Maximum:4}" lifecycle.capacity=-1
	// signal=136 source.position=0 source.side=Right source.reactor="-50% Defense" lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=0
	// signal=153 source.position=0 source.side=Left source.reactor="@Launch[..4]({$} Remove 2 Nerf)" lifecycle.leading=1 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=-1
	...
	// signal=186 source.position=0 source.side=Left source.reactor="@Launch({1!/%} 3 * 380% Damage)" lifecycle.leading=0 lifecycle.cooling="{Current:1 Maximum:4}" lifecycle.capacity=-1
	// signal=186 source.position=0 source.side=Left source.reactor="@Launch({1} 3 * 350% Damage, -50% Defense)" lifecycle.leading=0 lifecycle.cooling="{Current:2 Maximum:4}" lifecycle.capacity=-1
	// signal=200 source.position=0 source.side=Left source.reactor="@Launch[..4]({$} Remove 2 Nerf)" lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:0}" lifecycle.capacity=0
	// verb=purge reactors="[Nerf #2 Nerf #1]"
	...
	// signal=239 source.position=0 source.side=Left source.reactor="@Launch({1!/%} 3 * 380% Damage)" lifecycle.leading=0 lifecycle.cooling="{Current:0 Maximum:4}" lifecycle.capacity=-1
	// signal=239 source.position=0 source.side=Left source.reactor="@Launch({1} 3 * 350% Damage, -50% Defense)" lifecycle.leading=0 lifecycle.cooling="{Current:1 Maximum:4}" lifecycle.capacity=-1
	// signal=253 source.position=0 source.side=Left source.reactor="@Launch({1!/%} 3 * 380% Damage)" lifecycle.leading=0 lifecycle.cooling="{Current:4 Maximum:4}" lifecycle.capacity=-1
